  ...
  <p align="center">
    Programa feito em java utilizando threads e locks para simular um sistema bancario
    <br>
    </p>
</p>
...
Este projeto em Java utiliza threads e locks para simular um sistema de gerenciamento de lojas. O programa gerencia transações de clientes, permitindo que realizem compras em lojas e processando pagamentos a funcionários em tempo real.

Os dados são atualizados simultaneamente, mostrando o saldo atual dos clientes e das lojas após cada transação.
